  ...
  return (
    <div ref={containerRef} style={{ position: 'relative' }}>
      ...
      <button
        ...
        title="Meal Tracker"
        style={{ fontSize: '0.6rem', gap: '1px', color: shouldNudge ? '#34d399' : undefined }}
      >
              ...
              {data.water.map((checked, idx) => (
                <button
                  ...
                  style={{
                    ...
                    borderRadius: '2px',
                    background: checked ? 'rgba(59, 130, 246, 0.3)' : 'rgba(255,255,255,0.04)',
                    color: checked ? '#60a5fa' : 'transparent',
                    fontSize: '0.5rem',
                    fontWeight: 700,
                    cursor: 'pointer',
                    display: 'flex',
