...
export const useTranslate = (text, lang, prefetchTTS, shouldPrefetch, mood = 'default') => {
  ...
  useEffect(() => {
    ...
    if (IS_TOO_LONG || IS_FILLER || IS_TOO_SHORT) {
      ...
      if (IS_TOO_LONG) setTranslation(`(Text too long for direct translation [v4.27.0])`);
      return;
    }
    ...
    debounceTimerRef.current = setTimeout(async () => {
      ...
      console.log(`[${t()}] [v4.27.0] Translating ${langPair} (${wordCount}w): "${normText.substring(0, 30)}..."`);
