...
flowchart TD
  ...
  SessionState --> Soundboard["GreetingsPanel/useGreetingClip: soundboard studio + greeting editor"]
```
...
- Main files:
  ...
  - [`src/hooks/useGreetingClip.js`](../../src/hooks/useGreetingClip.js) · [`src/components/GreetingEditorView.js`](../../src/components/GreetingEditorView.js)
